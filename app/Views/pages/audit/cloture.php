...
<div class="card" style="margin-bottom: 20px;">
    <div class="card-body" style="padding: 15px 20px;">
        <form method="GET" action="<?= BASE_URL ?>/audit/cloture" style="display: flex; gap: 15px; align-items: flex-end; flex-wrap: wrap;">
...
<form action="<?= BASE_URL ?>/audit/saveCloture" method="POST" id="cloture_form">
    ...
    <div class="card" style="margin-top: 20px;" id="ecart_card">
        <div class="card-body" style="padding: 25px; text-align: center;">
            ...
            <div style="margin-top: 25px; display: flex; justify-content: center; gap: 15px;">
                ...
                <a href="<?= BASE_URL ?>/audit" class="btn btn-primary" style="background-color: var(--c-gray-600); padding: 12px 20px;">
