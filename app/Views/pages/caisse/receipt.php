<div style="margin-bottom: 20px;" class="no-print">
    <a href="<?= BASE_URL ?>/caisse" class="btn btn-primary" style="background-color: var(--c-navy);">
        <i class='bx bx-arrow-back'></i> Retour à la Caisse
    </a>
    <a href="<?= BASE_URL ?>/audit?tab=closings" class="btn btn-secondary" style="margin-left: 8px;">
        <i class='bx bx-book-content'></i> Registre des Clôtures (Audit)
    </a>
    <button onclick="window.print()" class="btn btn-accent" style="margin-left: 8px;">
